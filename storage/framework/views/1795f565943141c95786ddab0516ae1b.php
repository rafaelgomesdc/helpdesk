...
<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <a class="btn btn-secondary" href="<?php echo e(route('usuarios.index')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('nome', $usuario->nome)); ?>" required minlength="3">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="senha" class="form-label">Senha <small class="text-muted">(deixe em branco para manter atual)</small></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="contato" id="contato" class="form-control <?php $__errorArgs = ['contato'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('contato', $usuario->contato)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select name="setor_id" id="setor_id" class="form-select <?php $__errorArgs = ['setor_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $setores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($setor->id); ?>" <?php echo e(old('setor_id', $usuario->setor_id) == $setor->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="cargo_id" id="cargo_id" class="form-select <?php $__errorArgs = ['cargo_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $cargos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cargo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cargo->id); ?>" <?php echo e(old('cargo_id', $usuario->cargo_id) == $cargo->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="perfil_id" id="perfil_id" class="form-select <?php $__errorArgs = ['perfil_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $perfis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perfil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($perfil->id); ?>" <?php echo e(old('perfil_id', $usuario->perfil_id) == $perfil->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Área de Trabalho\FATEC ADS 2026_1\6_Programação Web - Dione (5º)\trabalho_final\resources\views/usuarios/edit.blade.php ENDPATH**/ ?>